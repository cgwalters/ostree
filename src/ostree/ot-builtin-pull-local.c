...
static char ** opt_sign_verify_summary;
...
static GOptionEntry options[] = {
  ...
  { "sign-verify", 0, 0, G_OPTION_ARG_STRING_ARRAY, &opt_sign_verify, "Verify commits signature (must specify --remote)", NULL },
  { "sign-verify-summary", 0, 0, G_OPTION_ARG_NONE, &opt_sign_verify_summary, "Verify summary signature (must specify --remote)", NULL },
  ...
  { GVariantBuilder builder;
    ...
    if (opt_sign_verify)
      g_variant_builder_add (&builder, "{s@v}", "sign-verify",
                             g_variant_new_variant (g_variant_new_strv ((const char*const*)opt_sign_verify, -1)));
    if (opt_sign_verify_summary)
      g_variant_builder_add (&builder, "{s@v}", "sign-verify-summary",
                             g_variant_new_variant (g_variant_new_strv ((const char*const*)opt_sign_verify_summary, -1)));
